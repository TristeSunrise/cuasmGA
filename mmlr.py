...
def main():
    ...
    ga_out = matmul(a, b, c, ga_kernel, M, N, K, grid, load_dir, "leaky_relu")
    ...
    # print(torch_output)
    if torch.allclose(ga_out, triton_output, atol=1e-2, rtol=0):
    ...
    @triton.testing.perf_report(
        triton.testing.Benchmark(
            ...
            line_vals=['cublas', 'ga', 'triton'],
            line_names=['cuBLAS', "Ga", "Triton"],
